        ...
        ITwsSettingsProvider twsSettingsProvider) : ICommand
    {
        ...
        private static CandidateDetails RebuildCandidateFromDatasetRow(EvaluationDatasetRow evaluation)
        {
            return new CandidateDetails
            {
                ...
                RecentDailyOpenSeries = [.. evaluation.RecentDailyOpenSeries],
                RecentDailyHighSeries = [.. evaluation.RecentDailyHighSeries],
                RecentDailyLowSeries = [.. evaluation.RecentDailyLowSeries],
                ...
                RecentH4OpenSeries = [.. evaluation.RecentH4OpenSeries],
                RecentH4HighSeries = [.. evaluation.RecentH4HighSeries],
                RecentH4LowSeries = [.. evaluation.RecentH4LowSeries],
                RecentH4CloseSeries = [.. evaluation.RecentH4CloseSeries],
