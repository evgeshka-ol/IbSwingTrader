        ...
        ITextLogger logger) : ICandidateEvaluator
    {
        ...
        private static CandidateEvaluationResult CreateBaseResult(CandidateDetails candidate)
        {
            return new CandidateEvaluationResult
            {
                ...
                RecentDailyBbWidthSeries = [.. candidate.RecentDailyBbWidthSeries],
                RecentDailyBbUpperBandSeries = [.. candidate.RecentDailyBbUpperBandSeries],
                RecentDailyBbMidBandSeries = [.. candidate.RecentDailyBbMidBandSeries],
                RecentDailyBbLowerBandSeries = [.. candidate.RecentDailyBbLowerBandSeries],
                RecentDailyRsiSeries = [.. candidate.RecentDailyRsiSeries],
                RecentDailyMacdLineSeries = [.. candidate.RecentDailyMacdLineSeries],
                RecentDailyMacdSignalSeries = [.. candidate.RecentDailyMacdSignalSeries],
                RecentDailyMacdHistogramSeries = [.. candidate.RecentDailyMacdHistogramSeries],
                RecentDailyMacdSeries = [.. candidate.RecentDailyMacdSeries],
                RecentWeeklyMaSeries = [.. candidate.RecentWeeklyMaSeries],
                RecentWeeklyBbMidDistanceSeries = [.. candidate.RecentWeeklyBbMidDistanceSeries],
                RecentWeeklyBbUpperDistanceSeries = [.. candidate.RecentWeeklyBbUpperDistanceSeries],
                RecentWeeklyBbWidthSeries = [.. candidate.RecentWeeklyBbWidthSeries],
                RecentWeeklyBbUpperBandSeries = [.. candidate.RecentWeeklyBbUpperBandSeries],
                RecentWeeklyBbMidBandSeries = [.. candidate.RecentWeeklyBbMidBandSeries],
                RecentWeeklyBbLowerBandSeries = [.. candidate.RecentWeeklyBbLowerBandSeries],
                RecentWeeklyRsiSeries = [.. candidate.RecentWeeklyRsiSeries],
                RecentWeeklyMacdLineSeries = [.. candidate.RecentWeeklyMacdLineSeries],
                RecentWeeklyMacdSignalSeries = [.. candidate.RecentWeeklyMacdSignalSeries],
                RecentWeeklyMacdHistogramSeries = [.. candidate.RecentWeeklyMacdHistogramSeries],
                RecentWeeklyMacdSeries = [.. candidate.RecentWeeklyMacdSeries],
                RecentH4MaSeries = [.. candidate.RecentH4MaSeries],
                RecentH4BbMidDistanceSeries = [.. candidate.RecentH4BbMidDistanceSeries],
                RecentH4BbUpperDistanceSeries = [.. candidate.RecentH4BbUpperDistanceSeries],
                RecentH4BbWidthSeries = [.. candidate.RecentH4BbWidthSeries],
                RecentH4BbUpperBandSeries = [.. candidate.RecentH4BbUpperBandSeries],
                RecentH4BbMidBandSeries = [.. candidate.RecentH4BbMidBandSeries],
                RecentH4BbLowerBandSeries = [.. candidate.RecentH4BbLowerBandSeries],
                RecentH4RsiSeries = [.. candidate.RecentH4RsiSeries],
                RecentH4MacdLineSeries = [.. candidate.RecentH4MacdLineSeries],
                RecentH4MacdSignalSeries = [.. candidate.RecentH4MacdSignalSeries],
                RecentH4MacdHistogramSeries = [.. candidate.RecentH4MacdHistogramSeries],
                RecentH4MacdSeries = [.. candidate.RecentH4MacdSeries],
                WeeklyBbDirection = candidate.WeeklyBbDirection,
                WeeklyBbRegime = candidate.WeeklyBbRegime,
                WeeklyBbMidSlope = candidate.WeeklyBbMidSlope,
                WeeklyBbWidthSlope = candidate.WeeklyBbWidthSlope,
                WeeklyBbUpperDistanceSlope = candidate.WeeklyBbUpperDistanceSlope,
                DailyBbDirection = candidate.DailyBbDirection,
                DailyBbRegime = candidate.DailyBbRegime,
                DailyBbMidSlope = candidate.DailyBbMidSlope,
                DailyBbWidthSlope = candidate.DailyBbWidthSlope,
                DailyBbUpperDistanceSlope = candidate.DailyBbUpperDistanceSlope,
                H4BbDirection = candidate.H4BbDirection,
                H4BbRegime = candidate.H4BbRegime,
                H4BbMidSlope = candidate.H4BbMidSlope,
                H4BbWidthSlope = candidate.H4BbWidthSlope,
                H4BbUpperDistanceSlope = candidate.H4BbUpperDistanceSlope,
