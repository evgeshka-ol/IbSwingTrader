        ...
        ITextLogger logger) : ICandidateEvaluator
    {
        ...
        private static CandidateEvaluationResult CreateBaseResult(CandidateDetails candidate)
        {
            return new CandidateEvaluationResult
            {
                ...
                PatternVerdictReason = "error",
                RecentDailyCloseSeries = [.. candidate.RecentDailyCloseSeries],
                RecentDailyOpenSeries = [.. candidate.RecentDailyOpenSeries],
                RecentDailyHighSeries = [.. candidate.RecentDailyHighSeries],
                RecentDailyLowSeries = [.. candidate.RecentDailyLowSeries],
                ...
                RecentH4OpenSeries = [.. candidate.RecentH4OpenSeries],
                RecentH4HighSeries = [.. candidate.RecentH4HighSeries],
                RecentH4LowSeries = [.. candidate.RecentH4LowSeries],
                RecentH4CloseSeries = [.. candidate.RecentH4CloseSeries],
            ...
            string error)
        {
            return new CandidateEvaluationResult
            {
                ...
                DetectedPattern = "Unknown",
                DetectedPipeline = "Unknown",
                PatternVerdictReason = $"Evaluation error: {error}",
                RecentDailyCloseSeries = [.. candidate.RecentDailyCloseSeries],
                RecentDailyOpenSeries = [.. candidate.RecentDailyOpenSeries],
                RecentDailyHighSeries = [.. candidate.RecentDailyHighSeries],
                RecentDailyLowSeries = [.. candidate.RecentDailyLowSeries],
